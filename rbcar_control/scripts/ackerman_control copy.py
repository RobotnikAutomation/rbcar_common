...
class cmdvel2gazebo:
    ...
    def __init__(self,car_wheel_base, car_wheel_threat, max_abs_steer, wheel_radius):
        ...
        self.rMin = self.L/math.tan(self.maxsteerInside)
    ...
    def process_cmd_vel_data(self,data):
        ...
        if data.angular.z != 0.0:
            ...
            rospy.loginfo("Steering Radius Raw="+str(steering_radius_raw))
    ...
    def publish(self):
        ...
        rospy.logerr("self.steering_radius= "+str(self.steering_radius))
